...
import argparse
from sksurgery-fred import __version__
...
def main(args=None):
    ...
    parser = argparse.ArgumentParser(description='Fiducial Registration Educational Demonstration')
    ...
    parser.add_argument(
        "--version",
        action='version',
        version='Fiducial Registration Educational Demonstration version ' + friendly_version_string)
